...
## Sample Properties
i.From the research conducted by Census(recource: https://www.census.gov/content/dam/Census/library/publications/2016/demo/p20-578.pdf), From figure 1 we can see that about 30 percent and 28 percent people in US has high school completion and Some college degree competion, respectively. And another 22 percent have Bachelor's degree, and roughly 13 percent have advanced degree. Compare to the distrubution of education and age in our sample, we think our sample is a randon smple from the U.S. population. 

ii. From the survey conducted by CloudResearch(resource: https://www.cloudresearch.com/resources/blog/who-uses-amazon-mturk-2020-demographics/), we can see that about 30 percent and 37 percent people on MTurk are in there 20's and 30's, respectively. And another 17% are in their 40’s, and roughly 11% are in their 50’s. Compared to the age distribution in our data, we think our sample appear to be a random sample from the MTURK population. However if we compare our sample with the genernal population distrubution of age for US that conducted in 2020, the age distrubution in our sample seem to be more younger than the age distrubution of U.S.

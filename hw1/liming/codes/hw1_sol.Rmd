...
```
We delete all observations with at least one missing in income, sirius and wharton. 
...
```
One important finding is that two people fill in "Yes" in wharton while "No" in sirius. This should not happen under our survey setting. It indicates that maybe some surveyors do the survey causally, which casts some doubt on the quality of the survey.
...
Cost Estimate: 
Reward per Assignment*total number of assignments + estimated fees to Mechanical Turk 

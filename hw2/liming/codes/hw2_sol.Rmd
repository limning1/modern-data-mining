...
stargazer::stargazer(fit1, type="text", align=TRUE)
```
...
stargazer::stargazer(fit3, type="text", align=TRUE)
```
...
ggplot(Auto, aes(x = cylinders , y = mpg)) + 
  ...
  labs(title = "Scatter Plot, year ~ mpg") +
  theme_bw()
stargazer::stargazer(fit4, type="text", align=TRUE)
```
...
stargazer::stargazer(fit5, type="text", align=TRUE)
```
